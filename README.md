...
- `documents/` contains source copies of resume/CV files.
- `public/` contains static files served from the site root, such as 3D model assets and PDFs linked directly from HTML.
